...
module.exports = client => {
    ...
    client.on("ready", () => {
        client.user.setActivity({
            name: "Dm me for help | >help | " + client.guilds.cache.size + " Guilds", type: "PLAYING", url: "https://twitch.tv/#"
        })
        setInterval(() => {
            client.user.setActivity({
                name: "Dm me for help | >help | " + client.guilds.cache.size + " Guilds", type: "PLAYING", url: "https://twitch.tv/#"
